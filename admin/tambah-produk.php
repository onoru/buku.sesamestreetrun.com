...
if(isset($_POST['tambah_produk'])) {
    ...
    $hasil=mysqli_query($conn,"INSERT INTO tb_produk SET nama_buku='$nama_buku', id_kategori='$id_kategori', pengarang='$pengarang', harga='$harga', image_buku='$image_buku'");
    if($hasil){
...
if(isset($_POST['edit_produk'])) {
    ...
    $hasil=mysqli_query($conn,"UPDATE tb_produk SET nama_buku='$nama_buku' ,id_kategori='$id_kategori', pengarang='$pengarang', harga='$harga', image_buku='$image_buku' WHERE id_produk='$id_produk'");
    if($hasil){
        header("location:manage.php?page=produk");
    }
}
